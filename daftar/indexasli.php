            ...
            <form class="m-t" role="form" method="post" action="../proses?valid=sistem&method=user_daftar" onsubmit="return validasi_input(this)">
                        <table width="100%">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="form-group">
                                    <input type="password" name="password" style="color: black;" class="form-control" placeholder="Passwor" required oninvalid="this.setCustomValidity('Masukan Password Terlebih Dahulu')" oninput="setCustomValidity('')" autocomplete="off">
                                    </div>
                                </td>
                                <td width="5%"></td>
                            </tr>
