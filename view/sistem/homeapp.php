...
<section class="content-header">
  <section class="content-header bg-teal" style="border-radius: 5px;">
    ...
    <marquee><b>ssssSelamat Datang Di Sistem Informasi Kenaikan Pangkat, Kenaikan Gaji Berkala dan Arsip Kepegawaian (SEPAKAT BERKAWAN) <?php
                                                                                                                                        echo $row_data['nama'];
                                                                                                                                        ?> <?php
  ...
  <table width="100%">
    <tr>
      <td align="center" width="15%">
        <img src="/logo/manimonki.png" style="width: 100px;">
      </td>
      <td width="85%">
