                    ...
                    <div class="panel-body table-responsive">
                        ...
                        <table width="100%" id="tabel" class="table table-bordered table-hover">
                            ...
                            <tbody>
                                ...
                                if (isset($data_proyek)) {
                                    while ($row_proyek= mysqli_fetch_array($data_proyek)) {
                                ?>

                                        <tr class="odd gradeX">
                                        <td><?php echo $nomor; ?></td>
                                            <td><?php echo $row_proyek['nama_proyek']; ?></td>
                                            <td><?php echo $row_proyek['status_proyek']; ?></td>
                                            <td><?php echo $row_proyek['tanggal_mulai']; ?></td>
                                            <td><?php echo $row_proyek['tanggal_selesai']; ?></td>
                                            <td>
                                                <center>
