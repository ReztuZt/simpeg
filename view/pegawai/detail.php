...
<section class="content">
    ...
    <a href="index.php?controller=upskilling&method=upskilling&nip=<?php echo $row_pegawai['nip']; ?>" class="btn btn-md btn-info" data-toggle="tooltip" data-placement="top" title="Lampiran"><i class="fa fa-exclamation"></i>upskill</a>
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body table-responsive">
                    ...
                    <button type="button" class="btn btn-warning btn-xs pull-right" data-toggle="modal" data-target="#modal-danger">
                        <li class="fa fa-circle-o-notch"></li> Edit
                    </button>
                    <br>
                    <table width="100%">

                        <div class="form-group text-center">
                            <img src="lost/photo/<?= $row_pegawai['nip'] ?>.jpg" alt="Gambar Pegawai" class="img-thumbnail" style="max-width: 200px;">
                        </div>
                        <!-- Form untuk mengubah foto -->
                        <div class="form-group text-center">
                            <form action="index.php?controller=pegawai&method=updateFoto" method="post" enctype="multipart/form-data" class="text-center mt-3">
                                <input type="hidden" name="nip" value="<?= $row_pegawai['nip'] ?>">

                                <div class="form-group text-center">
                                    <label for="file_foto"><?php echo $row_pegawai['nama']; ?></label>
                                    <input type="file" class="form-control-file" id="file_foto" name="file_foto" accept=".jpg, .jpeg, .png">
                                </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="form-group" id="data_1">
                                        <?php if ($row_pegawai['tmt_golongan'] == "0000-00-00") {
                                        } else {
                                            echo TanggalIndo($row_pegawai['tmt_golongan']);
                                        } ?>
                                    </div>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="form-group">
                                        <?php if ($row_pegawai['tgl_lahir'] == "0000-00-00") {
                                        } else {
                                            echo TanggalIndo($row_pegawai['tgl_lahir']);
                                        } ?>
                                    </div>
                                </td>
                                <td></td>
                                ...
                                <td>
                                    <div class="form-group">
                                        <?php if ($row_pegawai['tmt_capeg'] == "0000-00-00") {
                                        } else {
                                            echo TanggalIndo($row_pegawai['tmt_capeg']);
                                        } ?>
                                    </div>
                                </td>
                            </tr>
