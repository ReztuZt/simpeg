        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-heading bg-aqua">
                    <i class="fa fa-file-archive-o fa-fw"></i> History Pelanggaran
                    <div class="pull-right">
                            ...
                            ?>
                                    ...
                                    <tr class="odd gradeX">
                                        ...
                                        <td align="center">
                                            ...
                                            <center>
                                                <a href="index.php?controller=upskill&method=dataDeletehistory&id=<?php echo $row_pelanggaran['id']; ?>" class="btn btn-danger btn-xs" role="button" data-toggle="tooltip" data-placement="top" title="Delete" onClick="return confirm('Yakin hapus data <?php echo $row_pelanggaran['keterangan']; ?>?')"> <i class="fa fa-trash fa-fw"></i> </a>
                                            </center>
                                        </td>
                                        <td>
                                            <center>
                                                ...
                                                <!-- prefiew foto -->
                                                <div class="modal fade" id="preview<?php echo $row_pelanggaran['id']; ?>">
                                                    <div class=" modal-lg">
                                                        <div class="">
                                                            <div class="">
                                                        ...
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                    <span aria-hidden="true">&times;</span></button>
                                                                <center>
                                                                    <h4 class="modal-title">Ubah History</h4>
                                                                </center>
                                                            </div>
                                                            <form role="form" method="POST" action="index.php?controller=pegawai&method=ubah_history" enctype="multipart/form-data">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <div class="modal-body">
                                                                                ...
                                                                                <input type="text" name="pelanggaran" value="<?php echo $row_pelanggaran['pelanggaran']; ?>" id="nomor_kas" class="form-control" placeholder="Keterangan" required oninvalid="this.setCustomValidity('Masukkan Keterangan')" oninput="setCustomValidity('')" autocomplete="off">
                                                                                <input type="hidden" name="id" id="nomor_kas" value="<?php echo $row_pelanggaran['id']; ?>" class="form-control" placeholder="Masukkan Pelanggaran" required>
                                                                            </div>
                                                                        </td>
                                                                        <td></td>
                                                                    </tr>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <div class="modal-body">
                                                                                ...
                                                                                <input type="hidden" name="id" id="nomor_kas" value="<?php echo $row_pelanggaran['id']; ?>" class="form-control" placeholder="Masukkan Keterangan" required>
                                                                            </div>
                                                                        </td>
                                                                        <td></td>
                                                                    </tr>
...
<div class="modal modal-primary fade" id="modal-danger">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form role="form" method="POST" action="index.php?controller=upskill&method=insert_history" enctype="multipart/form-data">
                <table width="100%" class="modal-body">
                    <tr>
                        <td>
                            <div class="modal-body">
                        ...
                        <td>
                            <div class="modal-body">
                                <input type="hidden" name="nip" value="<?php echo $row_detail['nip']; ?>"></input>
                                <input name="keterangan" class="form-control" required oninvalid="this.setCustomValidity('Pilih Keterangan')" oninput="setCustomValidity('')" autocomplete="off">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="modal-body">
                                <input type="hidden" name="nip" value="<?php echo isset($row_detail['nip']) ? $row_detail['nip'] : ''; ?>">
                                <input type="text" name="jenis_pelanggaran" class="form-control" placeholder="Jenis pelanggaran" required oninvalid="setCustomValidity('Masukkan Jenis Pelanggaran')" oninput="setCustomValidity('')" autocomplete="off">
                            </div>
                        </td>
