<?php
	...
	function insertPelanggaran($nip, $jenis_pelanggaran, $tanggal_pelanggaran, $keterangan) {
        // Ambil data terakhir dari tabel pelanggaran untuk mendapatkan ID baru
        $lastPelanggaran = $this->db->order_by('id', 'DESC')->limit(1)->get('pelanggaran')->row();

        $id = ($lastPelanggaran) ? $lastPelanggaran->id + 1 : 1;
        ...
        // Sesuaikan 'nama_tabel_pelanggaran' dengan nama tabel yang benar di database Anda
