...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $employeeCode = $_POST['employee_nip'];

    $uploadDir = 'uploads/';
    $uploadFile = $uploadDir . $employeeNip . '_' . basename($_FILES['photo']['name']);
    ...
    if (move_uploaded_file($_FILES['photo']['tmp_name'], $uploadFile)) {
        ...
        $sql = "UPDATE freelance SET foto_path = '$uploadFile' WHERE nip = '$employeeNip'";
